...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `No sabes lo feliz que me haces, gracias por darme esta oportunidad. Prometo cuidar de ti, apoyarte y hacerte sonreír siempre. 💖 Me emociona mucho poder decir que ahora somos novios, te quiero muchísimo y estoy muy ilusionado por todo lo que viene contigo.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor,Brandon";
...
function playBackgroundMusic() {
  ...
  if (!btn) {
    ...
    aviso.id = 'music-text';
    aviso.textContent = '🔔 Pulsa el botón para activar la música';
    aviso.style.position = 'fixed';
    aviso.style.bottom = '80px';
    aviso.style.right = '18px';
    aviso.style.zIndex = 98;
    aviso.style.background = 'rgba(255,255,255,0.85)';
    aviso.style.padding = '6px 12px';
    aviso.style.borderRadius = '12px';
    aviso.style.fontSize = '0.9em';
    aviso.style.color = '#FF4081';
